...
import { productsCoffe } from "../data/productsDataCoffe"
                            ...
                            <a href="#" >
                                ...
                                <div className="px-4 py-3 w-72">
                                    ...
                                    <div className="flex items-center">
                                        <p className="text-lg font-semibold text-black cursor-auto my-3">{products.precio}</p>
                                        <del>
                                            <p className="text-sm text-gray-600 cursor-auto ml-2">{products.precioBefore}</p>
                                        </del>
